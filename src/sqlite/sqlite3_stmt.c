...
int sqlite3_step(sqlite3_stmt *pStmt) {
  ...
  db = v->db;
  sqlite3_mutex_enter(db->mutex);
  while ((rc = sqlite3Step(v)) == 17 && cnt++ < 50) {
    int savedPc = v->pc;
...
const char *sqlite3_column_name(sqlite3_stmt *pStmt, int N) { return columnName(pStmt, N, 0, 0); }

const void *sqlite3_column_name16(sqlite3_stmt *pStmt, int N) { return columnName(pStmt, N, 1, 0); }

const char *sqlite3_column_decltype(sqlite3_stmt *pStmt, int N) { return columnName(pStmt, N, 0, 1); }

const void *sqlite3_column_decltype16(sqlite3_stmt *pStmt, int N) { return columnName(pStmt, N, 1, 1); }
...
int sqlite3_bind_text16(sqlite3_stmt *pStmt, int i, const void *zData, int n, void (*xDel)(void *)) { return bindText(pStmt, i, zData, n & ~(u64)1, xDel, 2); }
...
int sqlite3_bind_parameter_index(sqlite3_stmt *pStmt, const char *zName) { return sqlite3VdbeParameterIndex((Vdbe *)pStmt, zName, sqlite3Strlen30(zName)); }
...
int sqlite3_stmt_readonly(sqlite3_stmt *pStmt) { return pStmt ? ((Vdbe *)pStmt)->readOnly : 1; }

int sqlite3_stmt_isexplain(sqlite3_stmt *pStmt) { return pStmt ? ((Vdbe *)pStmt)->explain : 0; }
